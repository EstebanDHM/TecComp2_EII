...
# Footer
footer_text = "Simulador de Cajas de Recompensa v1.0 | Da clic en 'Abrir caja' para probar tu suerte ✨"
footer_label = tk.Label(root, text=footer_text, font=("Arial", 9), bg=BG_COLOR, fg="#AAAAAA", anchor="center")
